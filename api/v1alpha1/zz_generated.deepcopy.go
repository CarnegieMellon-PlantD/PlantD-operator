...
func (in *ScenarioTask) DeepCopyInto(out *ScenarioTask) {
	*out = *in
	...
	out.SendingDevices = in.SendingDevices
	out.PushFrequencyPerMonth = in.PushFrequencyPerMonth
...
func (in *SimulationSpec) DeepCopyInto(out *SimulationSpec) {
	*out = *in
	if in.DigitalTwinRef != nil {
		in, out := &in.DigitalTwinRef, &out.DigitalTwinRef
		*out = new(v1.ObjectReference)
		**out = **in
	}
	if in.TrafficModelRef != nil {
		in, out := &in.TrafficModelRef, &out.TrafficModelRef
		*out = new(v1.ObjectReference)
		**out = **in
	}
	if in.NetCostRef != nil {
		in, out := &in.NetCostRef, &out.NetCostRef
		*out = new(v1.ObjectReference)
		**out = **in
	}
