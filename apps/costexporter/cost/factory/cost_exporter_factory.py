...
class CostExporterFactory:
  ...
  The CostExporterFactory provides a mechanism to create cost service instances for supported cloud
  ...
  Usage:
      aws_cost_service = CostExporterFactory.create('aws')  # Returns an instance of AWSCostService
      azure_cost_service = CostExporterFactory.create('azure)  # Returns an instance of AzureCostService
  """
  @staticmethod
  def create(service_type):
    ...
    :return: An instance of the appropriate cost service class (e.g., AWSCostExporter, AzureCostExporter).
