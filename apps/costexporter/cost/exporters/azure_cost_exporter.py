...
class AzureCostExporter(CostExporter):
    def __init__(self, *args, **kwargs):
        ...
        self.azure_subscription_id = data.get("AZURE_SUBSCRIPTION_ID", "")
        self.azure_tenant_id = data.get("AZURE_TENANT_ID", "")
    ...
    def _create_usage_client(self):
        ...
        try:
            ...
            usage_client = UsageManagementClient(
                credential=token_credential, subscription_id=self.azure_subscription_id
            )
    ...
    def _load_log_dict(self, item):
        ...
        log_dict["usage_start_time"] = item.usage_start_time.strftime(
            "%Y-%m-%d %H:%M:%S"
        )
    ...
    def _create_dataframe(self, usage_records):
        ...
        return (
            df[["meter_info", "usage_start_time", "cost", "tags"]]
            .groupby(["meter_info", "usage_start_time", "tags"])
            .sum()
        )
